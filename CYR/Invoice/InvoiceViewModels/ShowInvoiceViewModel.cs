    ...
    ObservableCollection<InvoicePosition> pos)
        {
            ...
            // Get the list of all available units of measure from the first position's collection
            ...
            foreach (var item in items)
            {
                ...
                // If a matching unit is found, set it as the selected item.
                // Otherwise, you might need to handle this case (e.g., set to null).
